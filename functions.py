...
# Enrollment times for 2023 Fall
TIMES = [
    datetime(2023, 5, 26, 8),   # first pass prio + seniors [0]
    datetime(2023, 5, 29, 8),   # first pass juniors [1]
    datetime(2023, 5, 30, 8),   # first pass sophomores [2]
    datetime(2023, 5, 31, 8),   # first pass freshmen [3]
    datetime(2023, 6, 3, 8),    # second pass prio + seniors [4]
    datetime(2023, 6, 6, 8),    # second pass juniors [5]
    datetime(2023, 6, 7, 8),    # second pass sophomores [6]
    datetime(2023, 6, 8, 8),    # second pass freshmen [7]
    datetime(2023, 6, 10),      # continuing students end [8]
    #datetime(2023, 8, 28, 8),   # first pass transfers [9]
    #datetime(2023, 8, 29, 8),   # first pass new students [10]
    #datetime(2023, 8, 31, 8),   # second pass transfers [11]
    #datetime(2023, 9, 1, 8),    # second pass new students [12]
    #datetime(2023, 9, 3),       # new students end [13]
    datetime(2023, 9, 28),      # classes start [14]
    datetime(2023, 10, 14)      # deadline to enroll/add [15]
]

# Enrollment times for 2024 Fall
TIMES_NEW = [
    datetime(2024, 5, 24, 8),   # first pass prio + seniors [0]
    datetime(2024, 5, 27, 8),   # first pass juniors [1]
    datetime(2024, 5, 28, 8),   # first pass sophomores [2]
    datetime(2024, 5, 29, 8),   # first pass freshmen [3]
    datetime(2024, 6, 1, 8),    # second pass prio + seniors [4]
    datetime(2024, 6, 4, 8),    # second pass juniors [5]
    datetime(2024, 6, 5, 8),    # second pass sophomores [6]
    datetime(2024, 6, 6, 8),    # second pass freshmen [7]
    datetime(2024, 6, 8),       # continuing students end [8]
    #datetime(2024, 8, 7),       # waitlists paused for incoming enrollment [9]
    #datetime(2024, 8, 12, 8),   # first pass transfers [10]
    #datetime(2024, 8, 13, 8),   # first pass new students [11]
    #datetime(2024, 8, 15, 8),   # second pass transfers [12]
    #datetime(2024, 8, 16, 8),   # second pass new students [13]
    #datetime(2024, 8, 18),      # new students end [14]
    datetime(2024, 9, 26),      # classes start [15]
    datetime(2024, 10, 12)      # deadline to enroll/add [16]
]
